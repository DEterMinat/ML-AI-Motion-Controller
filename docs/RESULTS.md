...
ผลการทดสอบบนชุดข้อมูล Test ของรอบประเมินแบบ honest split (ประมาณ 600 samples) มีรายละเอียดดังนี้:
...
1.  โมเดลอ้างอิง (MLP) มี **Test Accuracy 99.26%** ซึ่งหมายความว่าบนชุดทดสอบประมาณ 600 ตัวอย่าง โมเดลทายผิดเพียงเล็กน้อย
